        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" action="#">
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              Already have an account? <span @click="()=>{router.push('/login')}"
                class="font-medium text-primary-600 hover:underline cursor-pointer dark:text-primary-500">Login here</span>
            </p>
          </form>
        </div>
      </div>
...
const handleSubmit = async (e) => {
  ...
  if (data.firstName === '' || data.lastName === '' || data.emailAddress === '' || data.password === '' || data.userName === '') {
